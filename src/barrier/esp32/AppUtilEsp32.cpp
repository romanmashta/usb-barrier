...
#include "barrier/esp32/AppUtilEsp32.h"
#include "barrier/ArgsBase.h"

AppUtilEsp32::AppUtilEsp32(IEventQueue* events)
{
}



AppUtilEsp32::~AppUtilEsp32()
{
}
...
int
AppUtilEsp32::run(int argc, char** argv)
{
    return app().runInner(argc, argv, NULL, &standardStartupStatic);
}

void
AppUtilEsp32::startNode()
{
    app().startNode();
}
